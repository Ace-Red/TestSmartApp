    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                ...
                String query = "INSERT INTO public.employee (FullName, Password, SubdivisionID, PositionID, Status, PeoplePartnerID, OutOfOfficeBalance, Photo) VALUES ('"+fname+"', '"+password+"', '"+subdivision+"', '"+position+"', '"+status+"', '"+peoplepartner+"', '"+outoffbalance+"', '"+photo+"')";
