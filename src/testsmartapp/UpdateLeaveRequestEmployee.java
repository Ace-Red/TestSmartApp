...
public class UpdateLeaveRequestEmployee extends JFrame implements ActionListener{
    
    JTextField textfstartdate, textfenddate, textfcomment;
    JButton update, back;
    String leaveid;
    Choice reasonch;
    UpdateLeaveRequestEmployee(String leaveid) {
        this.leaveid = leaveid;
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        JLabel heading = new JLabel("Update Leave Request Detail");
        ...
        JLabel labelsubvision = new JLabel("Reason");
        ...
        String query = "SELECT * FROM public.leaverequest WHERE id = '"+leaveid+"'";
        String query1reason = "";
        ...
        try {
            ...
            while(rs.next()) {
                ...
                query1reason = "SELECT * FROM public.absencereason WHERE id = '"+rs.getString("absencereasonid")+"'";
                
            }
            ResultSet rs1 = c.s.executeQuery(query1reason);
            while(rs1.next()){
                reasonch.select(rs1.getString("reason"));
            } 
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                ...
                String query = "UPDATE public.leaverequest SET startdate = '"+startdate+"', enddate = '"+enddate+"', comment = '"+comment+"', absencereasonid = '"+reason+"' WHERE id = '"+leaveid+"'";
    ...
    public static void main(String[] args) {
        new UpdateLeaveRequestEmployee("");
    }
}
