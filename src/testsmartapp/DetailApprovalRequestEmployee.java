...
public class DetailApprovalRequestEmployee extends JFrame implements ActionListener{
    
    JButton back;
    String approvalid;
    DetailApprovalRequestEmployee(String approvalid) {
    ...
    public static void main(String[] args) {
        new DetailApprovalRequestEmployee("");
    }
}
