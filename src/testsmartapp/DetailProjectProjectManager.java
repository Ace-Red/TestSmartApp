...
public class DetailProjectProjectManager extends JFrame implements ActionListener{
    
    JButton back;
    String projectid;
    DetailProjectProjectManager(String projectid) {
    ...
    public static void main(String[] args) {
        new DetailProjectProjectManager("");
    }
}