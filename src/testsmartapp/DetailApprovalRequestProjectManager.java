...
public class DetailApprovalRequestProjectManager extends JFrame implements ActionListener{
    
    JButton back;
    String approvalid;
    DetailApprovalRequestProjectManager (String approvalid) {
    ...
    public static void main(String[] args) {
        new DetailApprovalRequestProjectManager("");
    }
}
