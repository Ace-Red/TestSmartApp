...
2) Створюжмо таблиці за допомогою запитів:
...
6) Запускаємо додаток через файл Login.java (Попередньо зробити запис в табличку Employee та заповнити такі поля своєю информацією (клас ConnectionDB)):
    static final String DB_URL = "jdbc:postgresql://127.0.0.1:5432/test_db";
    static final String USER = "postgres";
    static final String PASS = "..";)
7) Також в таблиці Position важливо зробыти записи, дотримуючись id та назви посад:
